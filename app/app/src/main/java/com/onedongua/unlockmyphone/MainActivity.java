...
public class MainActivity extends AppCompatActivity {
    static final String ENCRYPTED_PIN = "encrypted_pin";
    static final String DEVICE_IP = "device_ip";
    public static final String ACTION_UNLOCK_REQUEST =
            "com.onedongua.unlockmyphone.action.UNLOCK_REQUEST";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnUnlock.setOnClickListener(v -> requestUnlock(btnUnlock));

        if (ACTION_UNLOCK_REQUEST.equals(getIntent().getAction())) {
            isFromIntent = true;
            requestUnlock(btnUnlock);
            moveTaskToBack(true);
        }
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        setIntent(intent);
        if (ACTION_UNLOCK_REQUEST.equals(intent.getAction())) {
            isFromIntent = true;
            requestUnlock(findViewById(R.id.btn_unlock));
            moveTaskToBack(true);
        }
    }

    private void requestUnlock(Button btnUnlock) {
